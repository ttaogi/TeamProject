...
void loadResources()
{
	...
	IMAGEMANAGER->addFrameImage(KEY_SWIPE_BROADSWORD_RIGHT, DIR_SWIPE_BROADSWORD_RIGHT, 144, 144, 3, 1, 3, true, MAGENTA);
	IMAGEMANAGER->addFrameImage(KEY_SWIPE_BROADSWORD_LEFT, DIR_SWIPE_BROADSWORD_LEFT, 144, 144, 3, 1, 3, true, MAGENTA);
	IMAGEMANAGER->addFrameImage(KEY_SWIPE_BROADSWORD_TOP, DIR_SWIPE_BROADSWORD_TOP, 432, 48, 3, 1, 3, true, MAGENTA);
	IMAGEMANAGER->addFrameImage(KEY_SWIPE_BROADSWORD_BOTTOM, DIR_SWIPE_BROADSWORD_BOTTOM, 432, 48, 3, 1, 3, true, MAGENTA);
	...
	// ui.
	IMAGEMANAGER->addImage(KEY_UI_PRESS_ANY_KEY, DIR_UI_PRESS_ANY_KEY, 438, 36, true, MAGENTA);
