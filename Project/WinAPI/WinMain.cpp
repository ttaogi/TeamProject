...
void loadResources()
{
	...
	IMAGEMANAGER->addImage(KEY_STEPPING_STONE_LEFT, DIR_STEPPING_STONE_LEFT, 32, 32, true, MAGENTA);
	IMAGEMANAGER->addImage(KEY_STEPPING_STONE_TOP, DIR_STEPPING_STONE_TOP, 32, 32, true, MAGENTA);
	IMAGEMANAGER->addImage(KEY_STEPPING_STONE_RIGHT, DIR_STEPPING_STONE_RIGHT, 32, 32, true, MAGENTA);
	IMAGEMANAGER->addImage(KEY_STEPPING_STONE_BOTTOM, DIR_STEPPING_STONE_BOTTOM, 32, 32, true, MAGENTA);
