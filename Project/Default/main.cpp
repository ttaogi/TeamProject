...
void LoadResources() {
	IMG->AddFrameImage(KEY_PLAYER_IDLE_STRIPE, PLAYER_IDLE_STRIPE, 200, 100, 2, 1, 2, true, RGB(255, 0, 255));
	IMG->AddFrameImage(KEY_PLAYER_ATTACK_STRIPE, PLAYER_ATTACK_STRIPE, 800, 100, 4, 1, 4, true, RGB(255, 0, 255));
	IMG->AddFrameImage(KEY_PLAYER_ATTACKED_STRIPE, PLAYER_ATTACKED_STRIPE, 800, 100, 4, 1, 4, true, RGB(255, 0, 255));
	IMG->AddFrameImage(KEY_PLAYER_DEFFENCE_STRIPE, PLAYER_DEFFENCE_STRIPE, 400, 100, 4, 1, 4, true, RGB(255, 0, 255));

	IMG->AddImage(KEY_UI_START_BUTTON_STRIPE, UI_START_BUTTON_STRIPE, 200, 150, false, RGB(255, 0, 255));
}
